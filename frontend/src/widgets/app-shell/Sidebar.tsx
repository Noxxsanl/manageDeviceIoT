  ...
  return (
    <>
      <aside className="fixed left-0 top-0 z-30 flex h-screen w-60 flex-col border-r border-[#E5EAF0] bg-white">
        ...
        {/* Logo */}
        <div className="flex items-center gap-2.5 border-b border-[#E5EAF0] px-4 py-3.5">
        ...
        {/* User section */}
        <div className="border-t border-[#E5EAF0] p-2.5">
          <div ref={menuRef} className="relative">
            <div className="flex items-center gap-2.5 rounded bg-gray-50 px-3 py-2">
            ...
            {menuOpen && (
              <div className="absolute bottom-full left-0 right-0 mb-1 rounded border border-[#E5EAF0] bg-white py-1 shadow-md">
